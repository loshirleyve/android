package com.yun9.wservice.bean.support;
...
import com.yun9.wservice.bean.BeanParserException;
import com.yun9.wservice.bean.BeanInitException;
...
public class DefaultBeanContext implements BeanContext {
	...
	private static final Logger logger = Logger
			.getLogger(DefaultBeanContext.class);

	public DefaultBeanContext(Context context) {
