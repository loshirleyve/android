...
import com.yun9.mobile.form.impl.ImplEngineFileObtain2Attchment;
import com.yun9.mobile.form.impl.ImplEngineFileObtain2Camera;

public class FactoryEngineFileObtain2Attchment extends FactoryEngineFileObtain{

	@Override
	public EngineFileObtain creatEngineFileObtain(Context context, String name) {
		return new ImplEngineFileObtain2Attchment(context, name);
	}
