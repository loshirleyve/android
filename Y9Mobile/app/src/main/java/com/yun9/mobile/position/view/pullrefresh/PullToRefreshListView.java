package com.yun9.mobile.position.view.pullrefresh;



import com.yun9.mobile.R;
import com.yun9.mobile.position.view.pullrefresh.ILoadingLayout.State;
...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
    ...
    protected ListView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        mListView = listView;
//        listView.setDivider(getResources().getDrawable(R.color.lightblue));
