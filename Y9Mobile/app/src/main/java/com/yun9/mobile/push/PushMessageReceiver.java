...
public class PushMessageReceiver extends FrontiaPushMessageReceiver {
	...
	public static final String CACHE_KEY_BIND_USER_ID = "baidu_bind_user_id";
	
	public static final String PUSH_TYPE = "baidu";
	...
	public void onBind(Context context, int errorCode, String appid,
		...
		if (!PushSynchronization.isBaidu()) {
			return;
		}
		...
		// 缓存改信息
		Yun9Cache.getInstance().put(CACHE_KEY_BIND_USER_ID, userId);
		...
		if (errorCode == 0) {
			...
			if (AssertValue.isNotNull(user)
					&& AssertValue.isNotNullAndNotEmpty(user.getId())) {
				pushDeviceRegisterFactory.bind(appid, userId, channelId, requestId,PUSH_TYPE);
			}
		}
	}
	...
	public void onNotificationClicked(Context context, String title,
		...
		pushMessageActionFactory.dealWith(context,customContentString);
	}
	...
	public void onUnbind(Context context, int errorCode, String requestId) {
		...
		if (errorCode == 0) {
			...
			pushDeviceRegisterFactory.unBind(Yun9Cache.getInstance().getAsString(CACHE_KEY_BIND_USER_ID));
		}
	}
