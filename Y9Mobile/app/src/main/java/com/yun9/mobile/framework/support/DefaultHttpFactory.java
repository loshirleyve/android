...
import com.yun9.mobile.framework.exception.HttpException;
...
import com.yun9.mobile.framework.resources.RepositoryOutput;
		...
		if (!SystemMethod.isOpenNetwork(beanContext.getApplicationContext())) {
			if (AssertValue.isNotNull(callback)) {
				...
				response.setCause(beanContext.getApplicationContext()
						.getResources()
						.getString(com.yun9.mobile.R.string.network_error));
