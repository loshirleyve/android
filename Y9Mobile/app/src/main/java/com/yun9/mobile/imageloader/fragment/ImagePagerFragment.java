...
import com.yun9.mobile.imageloader.Constants;
...
public class ImagePagerFragment extends Fragment {
	...
	public ImagePagerFragment(List<DmImageItem> imageItems) {
	...
	private class ImageAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup view, int position) {
			...
			MyImageLoader.getInstance().displayImage(imageItems.get(position).getId(), imageView, options, new SimpleImageLoadingListener() {
				@Override
