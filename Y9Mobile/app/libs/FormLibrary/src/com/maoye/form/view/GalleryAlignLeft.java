...
public class GalleryAlignLeft extends Gallery {
	...
	public GalleryAlignLeft(Context context, AttributeSet attrs) {
		super(context, attrs);
		mCamera = new Camera();
	...
	public GalleryAlignLeft(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean onSingleTapUp(MotionEvent e) {
		try {
			Field f = GalleryAlignLeft.class.getSuperclass().getDeclaredField("mDownTouchPosition");
