...
public class DateTimePicker extends FrameLayout
{
    ...
    public DateTimePicker(Context context)
	{
    	super(context);
    	 ...
    	 inflate(context, R.layout.form_dlg_date_time, this);
    	 
    	 mYearSpinner=(NumberPicker)this.findViewById(R.id.np_year);
    	 mYearSpinner.setMinValue(0);
    	 mYearSpinner.setMaxValue(Integer.MAX_VALUE);
    	 mYearSpinner.setValue(mYear);
    	 mYearSpinner.setOnValueChangedListener(mOnYearChangeListener);
    ...
    private NumberPicker.OnValueChangeListener mOnYearChangeListener = new OnValueChangeListener() {
		@Override
