 ...
 */
public class PaymentInputAmountActivity extends JupiterFragmentActivity{
    ...
    @ViewInject(id=R.id.no_use_balance)
    private JupiterRowStyleTitleLayout noUserBalance;
    ...
    public static void start(Activity activity,InputTextCommand command) {
        Intent intent =  new Intent(activity,PaymentInputAmountActivity.class);
    ...
    private void buildView() {
        ...
        titleBarLayout.getTitleLeft().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PaymentInputAmountActivity.this.finish();
            }
        });
        ...
        noUserBalance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.putExtra(JupiterCommand.RESULT_PARAM,0+"");
    ...
    protected int getContentView() {
        return R.layout.activity_payment_input_amount;
    }
}
