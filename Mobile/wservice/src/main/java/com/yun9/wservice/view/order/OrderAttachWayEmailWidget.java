 ...
 */
public class OrderAttachWayEmailWidget extends JupiterRelativeLayout implements ISelectable {
    ...
    public OrderAttachWayEmailWidget(Context context) {
        super(context);
    }

    public OrderAttachWayEmailWidget(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OrderAttachWayEmailWidget(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    @Override
    protected int getContextView() {
        return R.layout.widget_order_attach_way_email;
    }
