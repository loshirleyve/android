 ...
 * @author Alan
 */
public class JupiterRoundImageView extends ImageView {
	...
	public JupiterRoundImageView(Context context) {
		super(context);
		mContext = context;
	}

	public JupiterRoundImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		setCustomAttributes(attrs);
	}

	public JupiterRoundImageView(Context context, AttributeSet attrs, int defStyle) {
