...
public class JupiterSegmentedGroup extends RadioGroup {
    ...
    private class LayoutSelector {
        ...
        private int getChildren() {
            return JupiterSegmentedGroup.this.getChildCount();
        }

        private int getChildIndex(View view) {
            return JupiterSegmentedGroup.this.indexOfChild(view);
        }
