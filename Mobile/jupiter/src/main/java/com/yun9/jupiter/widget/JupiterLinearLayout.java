 ...
 */
public abstract class JupiterLinearLayout extends LinearLayout {

    protected Context mContext;

    public JupiterLinearLayout(Context context) {
        super(context);
        mContext = context;
        this.inflate();
    ...
    public JupiterLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public JupiterLinearLayout(Context context, AttributeSet attrs, int defStyle) {
