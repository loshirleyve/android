 ...
 * @author Jeff Gilfelt
 */
public class JupiterBadgeView extends TextView{
    public static final int POSITION_TOP_LEFT = 1;
    public static final int POSITION_TOP_RIGHT = 2;
    public static final int POSITION_BOTTOM_LEFT = 3;
    public static final int POSITION_BOTTOM_RIGHT = 4;
    public static final int POSITION_CENTER = 5;
    public static final int POSITION_TOP_RIGHT_EDGE = 6;
    ...
    private static final int DEFAULT_BADGE_SIZE = ViewGroup.LayoutParams.WRAP_CONTENT;
    ...
    private int badgeHeight = DEFAULT_BADGE_SIZE;
    private int badgeWidth = DEFAULT_BADGE_SIZE;
    ...
    public JupiterBadgeView(Context context) {
        this(context, (AttributeSet) null, android.R.attr.textViewStyle);
    }

    public JupiterBadgeView(Context context, AttributeSet attrs) {
     ...
     */
    public JupiterBadgeView(Context context, View target) {
     ...
     */
    public JupiterBadgeView(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public JupiterBadgeView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public JupiterBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
    ...
    private void applyLayoutParams() {
        int w = DEFAULT_BADGE_SIZE;
        int h = DEFAULT_BADGE_SIZE;
        if (badgeWidth != w) {
            w = dipToPixels(badgeWidth);
        }
        if (badgeHeight != h) {
            h = dipToPixels(badgeHeight);
        }
     ...
     * @param badgeHeight 高
     */
    public void setBadgeSize(int badgeWidth,int badgeHeight) {
